...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected boolean isReadyForPullEnd() {
        if (pullRecyclerHelper != null) {
            return pullRecyclerHelper.isReadyForPullEnd() && isLastItemVisible();
        }
    ...
    protected boolean isReadyForPullStart() {
        if (pullRecyclerHelper != null) {
            return pullRecyclerHelper.isReadyForPullStart() && isFirstItemVisible();
        }
    ...
    public LoadingLayout getLoadingView(boolean isHeader) {
        if (isHeader) {

...
public abstract class AbsVideoScreenSwitchActivity extends BaseActivity {
     ...
     * @param videoPlayer
     */
    public abstract void addVideoPlayerToContainer(VideoAdwarePlayView videoPlayer);
    ...
    public void removeVideoPlayerFromContainer(VideoAdwarePlayView videoPlayer) {
        if (videoPlayer != null) {

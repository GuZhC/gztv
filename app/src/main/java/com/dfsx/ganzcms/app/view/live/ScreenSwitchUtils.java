...
public  class ScreenSwitchUtils {
    ...
    private ScreenOriginalLister m_cb;
...
//                            mActivity.setRequestedOrientation(1);
    ...
    public static ScreenSwitchUtils init(Context context) {
        if (mInstance == null) {
            synchronized (ScreenSwitchUtils.class) {
                if (mInstance == null) {
                    mInstance = new ScreenSwitchUtils(context,null);
                }
            }
        }
        return mInstance;
    ...
    public ScreenSwitchUtils(Context context,ScreenOriginalLister  cb) {

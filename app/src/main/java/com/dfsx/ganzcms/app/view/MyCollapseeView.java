...
public class MyCollapseeView extends AppCompatTextView implements View.OnClickListener {
    ...
    public MyCollapseeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyCollapseeView(Context context, AttributeSet attrs, int defStyleAttr) {

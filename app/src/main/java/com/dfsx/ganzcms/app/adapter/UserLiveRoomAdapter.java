 ...
 */
public class UserLiveRoomAdapter extends BaseEmptyViewRecyclerAdapter<Room> implements BaseRecyclerViewHolder.
        OnRecyclerItemViewClickListener {

    protected Context context;

    protected IRoomAdapterMoreSettingClickListener moreSettingClickListener;

    public UserLiveRoomAdapter(Context context, ArrayList<Room> list) {
    ...
    public void onBindItemView(BaseRecyclerViewHolder holder, int position) {
        ...
        holder.setOnRecyclerItemViewClickListener(this);
        setViewData(holder, position);
    }

    private void setViewData(final BaseRecyclerViewHolder holder, final int position) {

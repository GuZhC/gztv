...
/**
 * 上面图片 下面文字
 * Created by  heyang on 2017/11/14.
 */
public class ImagTopView extends LinearLayout {
    ...
    public ImagTopView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImagTopView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        firstView = createFirstView(R.id.two_rely_first);
...
//                NewViewID, firstDrawableBottom);
    ...
    private ImageView createFirstView(int id) {

...
public class LogcatPushHelper {

    private static LogcatPushHelper INSTANCE = null;
    ...
    public static LogcatPushHelper getInstance(Context context) {
        synchronized (object) {
            if (INSTANCE == null) {
                INSTANCE = new LogcatPushHelper(context);
            }
        }
        return INSTANCE;
    }

    private LogcatPushHelper(Context context) {
        init(context);

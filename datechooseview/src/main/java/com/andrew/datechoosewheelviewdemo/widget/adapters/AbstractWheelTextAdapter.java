...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    public static final int NORMAL_TEXT_COLOR = 0xFF757575;
    private int normaltextColor = NORMAL_TEXT_COLOR;
...
//        view.setPadding(0,dp2px(context,25),0,dp2px(context,25));

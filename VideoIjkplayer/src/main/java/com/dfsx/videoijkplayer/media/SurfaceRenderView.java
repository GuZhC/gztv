...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (sizeCallback != null) {
            sizeCallback.onRenderViewSize(mMeasureHelper.getMeasuredWidth(), mMeasureHelper.getMeasuredHeight());
        }
    }
    ...
    private IRenderViewSizeCallback sizeCallback;

    @Override
    public void setRenderViewSizeCallback(@NonNull IRenderViewSizeCallback callback) {

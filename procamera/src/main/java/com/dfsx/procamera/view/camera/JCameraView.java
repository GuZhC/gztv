package com.dfsx.procamera.view.camera;
...
import com.dfsx.procamera.view.camera.CaptureLayout;
import com.dfsx.procamera.view.camera.FoucsView;
import com.dfsx.procamera.view.camera.listener.*;
import com.dfsx.procamera.view.camera.state.CameraMachine;
import com.dfsx.procamera.view.camera.util.FileUtil;
import com.dfsx.procamera.view.camera.util.LogUtil;
import com.dfsx.procamera.view.camera.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        duration = a.getInteger(R.styleable.JCameraView_duration_max, 11 * 1000);       //没设置默认为10s
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initData() {
        layout_width = Util.getScreenWidth(mContext);
        //缩放梯度

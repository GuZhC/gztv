...
import com.dfsx.procamera.view.camera.listener.ErrorListener;
import com.dfsx.procamera.view.camera.util.*;
...
//
    ...
    public void startRecord(Surface surface, float screenProp, ErrorCallback callback) {
        ...
        if (mParams.getSupportedVideoSizes() == null) {
            ...
            videoSize = CameraParamUtil.getInstance().getPreviewSize(mParams.getSupportedVideoSizes(), 800,
                    screenProp);
        }

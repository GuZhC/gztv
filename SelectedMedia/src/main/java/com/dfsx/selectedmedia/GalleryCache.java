...
public class GalleryCache {
	 ...
	 */
	public void loadBitmap(ArrayAdapter mainActivity, String imageKey,
...
//					BitmapLoaderTask task = new BitmapLoaderTask(imageKey, ((VideoFragment)mainActivity).getAdapter());
					BitmapLoaderTask task = new BitmapLoaderTask(imageKey, mainActivity);
					task.execute();
...
//				}
	...
	private class BitmapLoaderTask extends AsyncTask<Void, Void, Bitmap> {
		...
		public BitmapLoaderTask(String imageKey, ArrayAdapter adapter) {
			mAdapter = adapter;
			mImageKey = imageKey;
		}

...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        cancelButton.setPadding(ConvertUtils.toPx(activity, 10), 0, ConvertUtils.toPx(activity, 10), 0);
        ...
        submitButton.setPadding(ConvertUtils.toPx(activity, 10), 0, ConvertUtils.toPx(activity, 10), 0);
